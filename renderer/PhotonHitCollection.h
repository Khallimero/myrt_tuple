...
public:
    ...
    PhotonHitCollectionElement* getPhotonHitCollectionElement(const PhotonBox& pBox)const;
    ObjCollection<PhotonHit>* getPhotonHitCollection(const PhotonBox& pBox)const;
