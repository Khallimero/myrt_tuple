...
Collection<PhotonHit>* PhotonHitCollection::addPhotonBox(const PhotonBox& pBox)
{
...
const Collection<PhotonHit>* PhotonHitCollection::getPhotonHitCollection(const PhotonBox& pBox)
{
