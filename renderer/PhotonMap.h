...
public:
    ...
    PhotonHitCollectionElement* getPhotonHitCollectionElement(int shapeId,const PhotonBox& pBox)const;
    ObjCollection<PhotonHit>* getPhotonHitCollection(int shapeId,const PhotonBox& pBox)const;
